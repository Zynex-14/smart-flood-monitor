...
4. **Access the Control Room Dashboard**:
   Open your browser and navigate to **`http://localhost:3000`** or view live online at **[(https://river-flood-control-system-dashboard.netlify.app/)](https://river-flood-control-system-dashboard.netlify.app/)**.
